...
const PANELS: FigurePanel[] = [
  {
    ...
    desc: 'หน้าประวัติการปล่อยมีรายการเดียวคือ v3.0 วันที่ 1 ต.ค. ที่รวม 48 การเปลี่ยนแปลงและขึ้นเตือนว่าล้ม ด้านใต้บันทึกว่ายังหาไม่เจอว่าตัวไหนพัง ต้องย้อนทั้งก้อน และของดี 47 อย่างถูกถอยตาม',
    viewBox: '0 0 300 240',
    Screen: BigBatchLog,
  },
  {
