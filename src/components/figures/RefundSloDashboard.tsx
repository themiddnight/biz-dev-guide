...
const PANELS: FigurePanel[] = [
  {
    label: 'มีแค่ SLA',
    note: 'รู้ตัวเมื่องบ Error เดือนนี้ถูกกินไปแล้ว',
    title: 'กราฟอัตราสำเร็จที่มีแค่เส้น SLA',
    desc: 'กราฟอัตราสำเร็จของ API คืนเงินช่วง 09:00 ถึง 11:00 เส้นกราฟอยู่ราว 99.95% แล้วดิ่งลงตัดเส้นประ SLA 99.5% (สัญญากับลูกค้า) พร้อมเครื่องหมายเตือนว่ากินงบ Error ของเดือนนี้ตอน 10:30 และกล่องบันทึกว่าลูกค้าแจ้งเข้ามาก่อนทีมรู้',
    viewBox: '0 0 300 220',
    Screen: SlaOnlyScreen,
  },
  {
    label: 'มี SLO เหนือ SLA',
    note: 'เตือนก่อน แก้ทันก่อนกินงบ Error',
