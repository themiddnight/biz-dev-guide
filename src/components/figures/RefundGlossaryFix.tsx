...
const PANELS: FigurePanel[] = [
  ...
  },
  {
    ...
    title: 'อภิธานศัพท์กลางและแชทที่ใช้คำเดียวกัน',
    desc: 'การ์ดอภิธานศัพท์ทีมนิยามคืนเงิน (Refund) ว่าร้านโอนเงินคืนลูกค้าเอง ไม่ใช่ Chargeback ที่ธนาคารดึงคืน ตามด้วยแชทเดิมสามข้อความที่ทุกคนใช้คำว่าคืนเงินในกรอบเดียวกัน และเครื่องหมายถูกว่าทุกคนหมายถึงสิ่งเดียวกัน',
    viewBox: '0 0 300 240',
    Screen: OneTermChat,
  },
];
