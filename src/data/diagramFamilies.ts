...
export const DIAGRAM_FAMILIES: DiagramFamily[] = [
  ...
  },
  {
    ...
    note: 'เป็นหมวดที่ business อ่านง่ายที่สุด จึงมักถูกใช้เป็นสะพานเปิดบทสนทนา — แต่ระวังว่ามันไม่ได้บอกอะไรเลยเรื่องสิ่งที่อยู่หลังจอ',
  },
  {
    id: 'thinking',
...
export const SWIMLANE_VS_SEQUENCE: {
  ...
  columns: [
    ...
    },
    {
      ...
      caption: 'เห็นชัดว่า **ลำดับและการรอ** เป็นยังไง — เลข 1-5 คือลำดับเวลา เส้นประคือการตอบกลับ และแท่งทึบยาวๆ ของ support บอกว่าเขาถูกรออยู่ตลอดทั้ง flow',
    },
  ],
};
