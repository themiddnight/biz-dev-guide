      ...
      blocks: [
        {
          ...
          footnote:
            'กำไรขั้นต้นของขายปกติคือ ฿1,290 − ฿780 = ฿510 (ราว 40%) แต่หลังหักค่าส่งและค่าธรรมเนียมเหลือ ฿421 คืนเงินหนึ่งเคสที่ไม่ได้ของคืน ต้องขายปกติ 3 ออเดอร์ถึงจะได้คืน นี่คือเหตุผลที่บั๊กคืนเงินใน [[s1|บทที่ 1]] แพงกว่าที่เห็น **ตัวเลขสมมติ**',
          mobile: 'stack',
        },
      ],
    },
