      ...
      blocks: [
        {
          ...
          intro:
            'SA ส่งมอบ solution design ที่ตอบว่า "ระบบจะมีหน้าตาแบบไหน" แต่ยังไม่ได้ตอบทุกรายละเอียดว่า "จะ implement ยังไงให้รอดในโค้ดจริง" engineer จึงต้องมีขั้นตอนคิดต่อและ "เขียนลง" ก่อนลงมือ เพราะการตัดสินใจที่อยู่แค่ในหัวใครคนหนึ่งจะหายไปพร้อมความทรงจำของเขา และคนอื่นในทีม (รวมถึงตัวเขาเองในอีก 6 เดือนข้างหน้า) จะไม่มีทางรู้ว่าทำไมถึงเลือกทางนี้',
          cards: [
            {
            ...
            },
            {
              ...
              def: 'บันทึกสั้นๆ ว่าทำไมทีมถึงเลือกทางเทคนิคทางหนึ่ง แทนอีกทางหนึ่งที่เคยพิจารณา พร้อมเหตุผลและข้อแลกเปลี่ยน (trade-off) ที่ยอมรับ — ดูลำดับชั้นเอกสารและตัวอย่าง ADR ได้ที่ [[s14|บทที่ 14]]\n**พูดแบบบ้านๆ** สมุดบันทึกเหตุผลตอนซื้อบ้าน — ทำไมเลือกหลังนี้ไม่ใช่อีกหลัง จะได้ไม่ต้องมานั่งเถียงซ้ำเมื่อคนใหม่เข้าทีมแล้วถามว่า "ทำไมไม่ทำแบบอื่น"',
            },
            {
        ...
        },
        {
          ...
          body:
            'บางทีมให้ engineer สองคนนั่งเขียนโค้ดชิ้นเดียวกันพร้อมกัน คนหนึ่งพิมพ์ อีกคนตรวจตราและคิดภาพรวม แลกบทบาทกันเป็นระยะ วิธีนี้แลกความเร็วระยะสั้นกับคุณภาพและการกระจายความรู้ที่ดีขึ้น มักใช้กับงานที่ซับซ้อนหรือมีความเสี่ยงสูง มากกว่าใช้ทุกงาน',
        },
      ],
    },
  ],
