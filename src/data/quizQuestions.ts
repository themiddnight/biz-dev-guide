  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        isCorrect: false,
        explanation: 'ช่องนี้คือหนี้ที่เพิ่งมองเห็นหลังได้เรียนรู้ ซึ่งเป็นเรื่องปกติเมื่อซอฟต์แวร์วิวัฒนาการ แต่สถานการณ์นี้ทีมรู้ตัวตั้งแต่แรก',
      },
      {
      ...
      },
      {
        ...
        isCorrect: true,
        explanation: 'ถูกต้อง! ทีม "ตั้งใจ" เพราะรู้ตัวว่ากำลังสร้างหนี้ และ "ประมาท" เพราะไม่บันทึกและไม่วางแผนจ่ายคืน หนี้แบบนี้ดอกเบี้ยจะทบต้นโดยไม่มีใครติดตาม ทางออกคือบันทึกหนี้ไว้ใน Backlog และกันเวลาจ่ายคืนทุกสปรินต์',
      },
    ],
    xp: 25,
  },
